...
@router.post("/messages/")
async def mcp_messages_endpoint_with_slash(request: Request):
    """
    MCP Server messages endpoint for POST requests with trailing slash.
    Used by streamableHttp transport.
...
async def mcp_messages_endpoint_with_path(path: str, request: Request):
    """
